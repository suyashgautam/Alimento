Alimento is a food ordering app which allows users to order food from their favourite restaurant and allows restaurant to manage the order status right from order confirmation to delievery of order.
